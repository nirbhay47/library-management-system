...
public class loginpg1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Guest Login");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setText("Member Login");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel4.setText("Diamond member login");
        ...
        jLabel14.setText("look at our best books");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            br.close();
            fr.close();
            datas=datas+jTextField1.getText()+":"+jTextField8.getText();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            for(int i=0; i<fdata.length;i++){
                ...
                if(line[0].compareTo(name)==0 && line[1].compareTo(pswd)==0){
                    member p1=new member();
                    p1.setname(name);
                    p1.show();
                    this.hide();
                    String fname1="src//lms//thismem.txt";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
     try{
         ...
         String pswd=jTextField7.getText();
         if(name.compareTo("nirbhay")==0&&pswd.compareTo("pssd")==0){
