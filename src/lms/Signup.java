...
public class Signup extends javax.swing.JFrame {
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        String pswd1=jTextField3.getText();
        String type=jTextField4.getText();
        if(pswd.compareTo(pswd1)==0){
            if(type.compareTo("D")==0){
                String data=name+":"+pswd+":"+"none:none:none:none:none";
                try{
                ...
                String data=name+":"+pswd+":"+"none:none:none";
                try{
            ...
            jTextField5.setText("Successful!!");
        }
        else{
